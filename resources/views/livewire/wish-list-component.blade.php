                        ...
                        <li class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                ...
                                <div class="product-info">
                                    <a href="{{ route('product.details',['slug'=>$product->model->slug])}}" class="product-name"><span>{{$product->name}}</span></a>
                                    ...
                                    <a href="" wire:click.prevent="removeToWishList({{$product->model->id}})" ><i class="fa fa-heart fill-heart" ></i></a>
