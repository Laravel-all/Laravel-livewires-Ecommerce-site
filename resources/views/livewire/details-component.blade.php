                ...
                <div class="detail-info">
                    ...
                    <div class="quantity">
                        ...
                        <div class="quantity-input">
                            ...
                            <a class="btn btn-increase" href="increaseQuantity"></a>
                        </div>
                    </div>
                    ...
                    <li class="product-item">
                            <div class="product product-widget-style">
                                <div class="thumbnnail">
                                    <a href="{{ route('product.details',['slug'=>$popular_product->slug])}}" title="Radiant-360 R6 Wireless Omnidirectional Speaker [White]">
                    ...
                    @foreach ($related_products as $related_product)
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="{{ route('product.details',['slug'=>$related_product->slug])}}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                            ...
                            <div class="product-info">
                                ...
                                <div class="wrap-price"><span class="product-price">${{$related_product->regular_price}}.00</span></div>
                            </div>
                        </div>
                        @endforeach
