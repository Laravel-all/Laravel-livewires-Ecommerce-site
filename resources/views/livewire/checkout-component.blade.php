				...
				<div class="col-md-12">
								...
								<div class="billing-address">
										...
										<p class="row-in-form">
											...
											<input  type="text" name="add" value="" placeholder="Street at apartment number 1" wire:model="line1">
											@error('line1') <span class="text-danger">{{$message}} </span> @enderror

										</p>
										<p class="row-in-form">
											<label for="add">line 2:</label>
											<input  type="text" name="add" value="" placeholder="Street at apartment number 2" wire:model="line2">
										...
										<p class="row-in-form fill-wife">
											...
											<label class="checkbox-field">
												<input name="different-add" id="different-add" value="1" type="checkbox" wire:model="ship_to_diffrent" >
				...
				<div class="summary summary-checkout">
					<div class="summary-item payment-method">
					 ...
					 @endif
						...
						@endif
						<button class="btn btn-medium" type="submit">Place your order</button>
					</div>
