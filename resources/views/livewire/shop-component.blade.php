							...
							<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
								<div class="product product-style-3 equal-elem ">
									...
									<div class="product-info">
										...
										<a href="" wire:click.prevent="removeToWishList({{$product->id}})" ><i class="fa fa-heart fill-heart" ></i></a>
										@else
						...
						<div class="widget-content">
							<ul class="list-category">
								...
								<li class="category-item">
									<a href="{{ route('product.cetegory',['category_slug'=>$category->slug]) }}" class="cate-link">{{$category->name}}</a>
								</li>
								@endforeach
							</ul>
						</div>
