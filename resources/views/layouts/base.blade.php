				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+123) 456 789" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+94) 70 2310 137</a>
								</li>
							</ul>
						</div>
							...
							<ul>
								...
								@auth
														...
														@if(Auth::user()->uType === 'ADM')
																	...
																	<li class="menu-item menu-item-has-children parent" >
																		...
																		<ul class="submenu curency" >
																			<li class="menu-item" >
																				<a title="DashBoard" href="{{ route('admin.dashboard') }}">Admin</a>
																			</li>
																			<li class="menu-item" >
																			...
																			<li class="menu-item" >
																				<a title="slider" href="{{ route('admin.homeslider') }}">Manage Home Slider</a>
																			</li>

																				<li class="menu-item" >
																				<a title="Mange home Category" href="{{ route('admin.homecategories')}}">Manage Home Categories</a>
																			</li>
														...
														<li class="menu-item menu-item-has-children parent" >
																		...
																		<ul class="submenu curency" >
																		<li class="menu-item" >
																				<a title="DashBoard" href="{{ route('user.dashboard') }}">User</a>
																			</li>
																			<li class="menu-item" >
...
<script src="https://cdn.tiny.cloud/1/vyi3ev0hwf83bpm6ejm5tywtmmb7axlwef9nhj0wx0pwttdx/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
